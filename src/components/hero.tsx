...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    // Preload all images
    [...conImages, ...fiverrImages, ...icoImages].forEach((src) => {
      const img = new window.Image();
      img.src = src;
    });
    ...
    let fiverrTl: gsap.core.Timeline | null = null;
    ...
    const timer = setTimeout(() => {
      ...
      fiverrTl = animateBgLayers(fiverrBgLayersRef.current, fiverrImages.length);
          ...
          <div className="flex flex-col lg:flex-row justify-between lg:items-center lg:mt-[2vh] mt-[1vh]">
            ...
            >
              ...
              <div className="relative 2xl:w-[201px] xl:w-[160px] lg:w-[150px] w-[140px] h-[51px] rounded-full">
                ...
                <div className={`relative z-10 flex items-center justify-center gap-4 2xl:mt-[1.1vh] ${isSpecialScreen ? "mt-[2.4vh]" : "mt-[1.5vh]"}`}>
                  <Link
