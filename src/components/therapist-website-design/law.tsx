      ...
      <div className="relative z-10">
        <div>
          ...
          <h2 className="font-bricolage font-bold 2xl:text-[44px] xl:text-[38px] lg:text-[36px] text-[32px] md:leading-[142%] leading-[120%] tracking-[-0.04em] uppercase text-center text-white">
            Is Your Fitness Website Costing You Clients?
          </h2>
          ...
          >
            Nobody tells you your website lost them. They just chose the coach
            whose site made them feel more confident
          </p>
        ...
        <div className="mt-[3vh]">
          ...
          <div className="flex lg:flex-nowrap md:flex-wrap md:flex-row flex-col lg:justify-between justify-center md:gap-[20px] lg:gap-0 gap-[20px] items-center">
            ...
            >
              ...
              <p className="font-bricolage font-normal xl:text-[16px] text-[14px] leading-[130%] tracking-[-0.01em] capitalize text-white">
                Which, in a trust-based industry, is a bigger problem than it
                seems
              </p>
            </div>
            <div
            ...
            >
              ...
              />
              <h4 className="font-bricolage font-bold xl:text-[20px] text-[18px] xl:leading-[142%] leading-[100%] capitalize text-white my-[1.3vh]">
                No Real Consultation Funnel
              </h4>
              <p className="font-bricolage font-normal xl:text-[16px] text-[14px] leading-[130%] tracking-[-0.01em] capitalize text-white">
                A buried contact form is not a growth strategy
              </p>
            </div>
            <div
              ref={(el) => {
            ...
            >
              ...
              <p className="font-bricolage font-normal xl:text-[16px] text-[14px] leading-[130%] tracking-[-0.01em] capitalize text-white">
                If visitors don’t understand your value instantly, they leave
              </p>
            </div>
          </div>
          ...
          <div className="flex lg:flex-nowrap md:flex-wrap md:flex-row flex-col lg:justify-between justify-center gap-[20px] lg:gap-0 mt-[20px] items-center xl:mt-[3vh] lg:mt-0 md:mt-[1.5vh]">
            ...
            >
              ...
              <p className="font-bricolage font-normal xl:text-[16px] text-[14px] leading-[130%] tracking-[-0.01em] capitalize text-white">
                A passive website never turns visitors into paying clients
              </p>
            </div>
            <div
              ref={(el) => {
            ...
            >
              ...
              <p className="font-bricolage font-normal xl:text-[16px] text-[14px] leading-[130%] tracking-[-0.01em] capitalize text-white">
                As most fitness searches happen on a phone, speed matters
              </p>
            </div>
            <div
              ref={(el) => {
            ...
            >
              ...
              />
              <h4 className="font-bricolage font-bold xl:text-[20px] text-[18px] xl:leading-[142%] leading-[100%] capitalize text-white my-[1.3vh]">
                Builds Zero Immediate Credibility
              </h4>
              <p className="font-bricolage font-normal xl:text-[16px] text-[14px] leading-[130%] tracking-[-0.01em] capitalize text-white">
                First impressions online are formed faster than you think
              </p>
            </div>
          </div>
        </div>
        ...
        >
          Potential clients compare multiple coaches quickly. If your site
          doesn’t build trust instantly, they move on.
        </p>
      </div>
    </section>
  );
