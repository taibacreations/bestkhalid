...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        width={100}
        alt="dots"
        className={`absolute 2xl:bottom-[5vh] md:bottom-[7vh] bottom-0 left-0 z-30 w-full ${
      ...
      <div className="relative max-w-[1525px] mx-auto xl:px-10 px-4 flex md:mt-[17.5vh] mt-[2vh]">
        ...
        {/* ✅ Animated Social Links Pill — outside contentRef, z-40 above blur */}
        <div
          ref={socialRef}
          style={{ willChange: "transform, opacity" }}
          className="absolute md:-bottom-[10vh] -bottom-[7vh] left-4 xl:left-10 md:flex items-center gap-1 z-40 hidden"
        >
  ...
  2xl:mt-[1.1vh] 
  ${isTargetScreen ? "md:mt-[2.4vh]" : "md:mt-[1.6vh]"} 
  mt-[1.3vh]`}
            >
              <Link
        ...
        <div>
          <img
            ref={imageRef}
            src="/therapist-website-design/banner.webp"
            alt="Banner Image"
            style={{ willChange: "transform, opacity" }}
            className={`lg:w-[450px] md:w-[400px] w-[78vw] h-auto absolute 2xl:-top-[7.2vh] xl:-top-[5vh] md:top-[6vh] lg:top-[3.5vh] top-[63vh] lg:right-[6%] md:right-0 left-[50%] -translate-x-1/2 md:left-auto md:translate-x-0 z-20 ${isShortHeight ? "2xl:w-[600px] 2xl:right-[-1%]" : "2xl:w-[694px] 2xl:right-[-2.5%]"} ${isTargetScreen ? "xl:w-[35%]" : "xl:w-[41%]"}`}
          />
