...
const Process = () => {
  ...
  return (
    <section
    id="process"
      className="xl:pb-31 pb-10 bg-black xl:px-10 px-5 2xl:mt-[-5.5vh] lg:mt-[-15vh] mt-[-25vh] md:mt-[-20vh] xl:mt-0 relative scroll-mt-[10vh]"
    >
      <Image
        src="/lead-blur.webp"
        height={100}
      ...
      <div>
        <div id="proces" className="text-center max-w-[992px] mx-auto z-40 relative">
          ...
          <p id="process-content" className="mt-5.5 font-bricolage font-normal xl:text-[18px] md:text-[16px] text-[14px] tracking-[0em] leading-[142%] text-white">
