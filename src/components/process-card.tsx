    ...
    <div className="md:bg-[url(/process.png)] xl:rounded-[32px] lg:rounded-[20px] rounded-[14px] 2xl:bg-cover bg-no-repeat bg-contain bg-center 2xl:w-[1450px] min-h-[303px] mx-auto flex flex-col gap-8 md:flex-row md:justify-between items-center 2xl:px-31 lg:px-20 md:px-10 relative xl:mt-10 lg:mt-0 md:-mt-10 mt-[5vh] z-30">
      ...
      <div className="md:max-w-[311px] max-w-full z-20 process rounded-[14px]">
        ...
        <BorderBeam
          ...
          colorFrom="#00000000" // fully transparent
          colorTo="#7AB4FD"
          className="z-40 relative rounded-[32px] md:hidden mb-101"
        />
        <BorderBeam
          size={100}
          duration={8}
      ...
      <div className="md:max-w-[311px] max-w-full z-20 process rounded-[14px]">
        ...
        <BorderBeam
          ...
          colorFrom="#00000000" // fully transparent
          colorTo="#7AB4FD"
          className="z-40 relative rounded-[32px] md:hidden mt-45.5 mb-50.5 mb-process-2"
        />
        <BorderBeam
          size={100}
          duration={8}
      ...
      <div className="md:max-w-[311px] max-w-full z-20 process rounded-[14px]">
        ...
        <BorderBeam
          ...
          colorFrom="#00000000" // fully transparent
          colorTo="#7AB4FD"
          className="z-40 relative rounded-[32px] md:hidden mt-96 mb-process-3"
        />
        <BorderBeam
          size={100}
          duration={8}
