  ...
  mt-[1.3vh]`}
        ...
        <div>
          ...
          <div
            ref={floatingCtaRef}
            style={{ willChange: "transform, opacity" }}
            className="absolute lg:-bottom-[5vh] md:bottom-[8vh] md:top-auto top-[102vh] 2xl:right-[7%] xl:right-[11%] md:right-[7%] left-[50%] -translate-x-1/2 md:left-auto md:translate-x-0 z-40"
          >
            <Link
              href="/portfolio"
