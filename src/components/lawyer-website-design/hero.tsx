      ...
      <div className="relative max-w-[1525px] mx-auto xl:px-10 px-4 flex md:mt-[17.5vh] mt-[2vh]">
        ...
        >
          ...
          <div className="relative 2xl:w-[201px] xl:w-[160px] lg:w-[150px] w-[140px] md:h-[51px] h-[40px] rounded-full">
            ...
            <div className={`relative z-10 flex items-center justify-center gap-4 rounded-full 2xl:mt-[1.1vh] mt-[1.3vh] ${isSpecialScreen ? "md:mt-[2.4vh]" : "md:mt-[1.6vh]"}`}>
              <Link
        ...
        <div>
          <img
            ...
            alt="Banner Image"
            style={{ willChange: "transform, opacity" }}
            className="2xl:w-[806px] xl:w-[680px] lg:w-[500px] md:w-[400px] w-full lg:h-auto md:h-full h-auto absolute xl:-top-[2vh] md:top-[6vh] lg:top-[4vh] top-[52vh] 2xl:right-[-4%] md:right-0 left-[50%] -translate-x-1/2 md:left-auto md:translate-x-0 z-20"
          />
          {/* ✅ Floating CTA — z-40 to sit above blur */}
          <div
            ref={floatingCtaRef}
            style={{ willChange: "transform, opacity" }}
            className="absolute lg:-bottom-[15.2vh] md:-bottom-[10vh] md:top-auto top-[100vh] 2xl:right-[7%] xl:right-[11%] md:right-[7%] left-[50%] -translate-x-1/2 md:left-auto md:translate-x-0 z-40"
          >
            <Link
              href="/portfolio"
